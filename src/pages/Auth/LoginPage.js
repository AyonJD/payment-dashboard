      ...
      <div className="container mx-auto px-4">
        <div className="flex content-center items-center justify-center h-[100vh]">
          <div className="w-full lg:w-4/12 px-4">
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-200 border-0 bg-white">
                    ...
                    <>
                      <form>
                        ...
                        <div className="text-center mt-6">
                          <button
                            onClick={onSignIn}
                            className="bg-bkash flex gap-1 items-center justify-center text-white active:bg-gray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                            type="button"
                          >
                            {loading && (
                              <ImSpinner9 size={15} className=" animate-spin" />
